...
import { Carousel, Card } from "#/components/home/works-cards";

export function WorksSections() {
  ...
  return (
    <div className="h-full w-full py-20">
      <h2 className="mx-auto max-w-7xl pl-4 font-sans text-3xl font-bold text-neutral-800 dark:text-neutral-200 md:text-5xl">
        Some of our works
      </h2>
