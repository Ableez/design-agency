...
ALTER TABLE "asterisk_design_job" ADD CONSTRAINT "asterisk_design_job_design_delivery_option_asterisk_design_delivery_option_id_fk" FOREIGN KEY ("design_delivery_option") REFERENCES "public"."asterisk_design_delivery_option"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
